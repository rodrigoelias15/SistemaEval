        ...
        <form id="form1" method="post" class="formulario">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador1a" class="form-check-input" type="radio" name="questionario_item1" value="Apresenta textos e/ou elementos gráficos estáticos (figuras e fotos) em seu enunciado, respostas e informações adicionais." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador1b" class="form-check-input" type="radio" name="questionario_item1" value="Apresenta textos e/ou elementos gráficos no formato de mídias como, figuras, fotos vídeos e/ou sons com algum tipo de animação." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador2a" class="form-check-input" type="radio" name="questionario_item2" value="Apresenta possibilidade para que o aluno interfira na questão/resposta apenas com a opção 'clicar' com auxílio, por exemplo, de mouse ou touch screen." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador2b" class="form-check-input" type="radio" name="questionario_item2" value="Apresenta meios para que o aluno interfira na questão/resposta como, selecionar, arrastar, manipular ou desenhar com auxílio, por exemplo, de mouse ou touch screen" onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade ">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador3a" class="form-check-input" type="radio" name="questionario_item3" value="Não apresenta orientações para o usuário de como percorrer para desenvolver a questão." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador3c" class="form-check-input" type="radio" name="questionario_item3" value="Apresenta orientações para o usuário de como percorrer para desenvolver a questão de forma explícita (textual, elementos gráficos ou audiovisual)." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade ">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador4a" class="form-check-input" type="radio" name="questionario_item4" value="Apresenta possibilidade para que o usuário seja capaz de se mover na questão somente para frente ou para trás por meio de uma sequência linear e pré-definida." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador4b" class="form-check-input" type="radio" name="questionario_item4" value="Apresenta possibilidade para que o usuário seja capaz de se mover de forma intuitiva na questão por meio de uma sequência não linear e pré-definidas (Ex.: menus)." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador4c" class="form-check-input" type="radio" name="questionario_item4" value="Apresenta possibilidade para que o usuário seja capaz de se mover na questão de forma livre e autônoma." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador5a" class="form-check-input" type="radio" name="questionario_item5" value="Não apresenta opção de ajuda ou retorno." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador5b" class="form-check-input" type="radio" name="questionario_item5" value="Apresenta retorno como mensagens ou feedbacks." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador5c" class="form-check-input" type="radio" name="questionario_item5" value="Apresenta opção de ajuda e retorno como mensagens ou feedbacks." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador6a" class="form-check-input" type="radio" name="questionario_item6" value="Após a ação do usuário em finalizar, o sistema apresenta o próximo item do processo avaliativo numa sequência linear e pré-definida." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador6b" class="form-check-input" type="radio" name="questionario_item6" value="Após a ação do usuário em finalizar, o sistema apresenta o próximo item do processo avaliativo numa sequência não linear." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador6c" class="form-check-input" type="radio" name="questionario_item6" value="As escolhas das ações do usuário determinam a sequência e a continuidade do processo avaliativo (uso de chatbots/inteligência artificial etc)." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador9a" class="form-check-input" type="radio" name="questionario_item9" value="O enunciado e respostas não criam possibilidades de associações, simulações e conectividade, ou seja, não há interligação de temas, de experiências, de modo a se desdobrar/promover outras conexões/ligações." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador9b" class="form-check-input" type="radio" name="questionario_item9" value="O enunciado e respostas criam possibilidades de associações e simulações, porém não há  conectividade, ou seja, não há interligação de temas, de experiências, de modo a se desdobrar em outras conexões/ligações." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador9c" class="form-check-input" type="radio" name="questionario_item9" value="O enunciado e respostas criam possibilidades de associações, simulações e a conectividade, ou seja, há a interligação de temas, de experiências, de modo a se desdobrar em outras conexões/ligações." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador10a" class="form-check-input" type="radio" name="questionario_item10" value="O enunciado e respostas não promovem e/ou não favorecem a interferência/manipulação do usuário no objeto/item." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador10b" class="form-check-input" type="radio" name="questionario_item10" value="O enunciado e respostas promovem e/ou favorecem pontualmente e de forma controlada e restrita a interferência/manipulação do usuário no objeto/item." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador10c" class="form-check-input" type="radio" name="questionario_item10" value=" O enunciado e respostas promovem e/ou favorecem a interferência/manipulação do usuário no objeto/item." onclick="somaInteratividade()">
            ...
            <section class="form-group">
                ...
                <fieldset class="indicador_interatividade">
                    <legend>Critérios:</legend>
                    <div class="form-group form-check">
                        <input id="indicador11a" class="form-check-input" type="radio" name="questionario_item11" value=" O enunciado e respostas não promovem ações do usuário no item em múltiplas direções, em múltiplos formatos e com diversas mídias e recursos." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador11b" class="form-check-input" type="radio" name="questionario_item11" value="O enunciado e respostas promovem ações do usuário no item em direções específicas e direcionadas, mas com mídias, recursos e formatos diversos." onclick="somaInteratividade()">
                    ...
                    <div class="form-group form-check">
                        <input id="indicador11c" class="form-check-input" type="radio" name="questionario_item11" value="O enunciado e respostas promovem ações do usuário no item em múltiplas direções, em múltiplos formatos e com diversas mídias e recursos." onclick="somaInteratividade()">
