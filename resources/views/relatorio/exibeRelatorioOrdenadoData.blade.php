...
@section('content')
    <?php
        ...
        $relatorio_questionario = DB::table('questionario')->orderBy('data_item_digital_questionario')->get();
        $ordenaData = $relatorio_questionario;
    ?>

    <div class="row">
        @foreach ($ordenaData as $questionario)
