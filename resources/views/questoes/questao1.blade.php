...
<section class="form-group">
    ...
    <fieldset class="indicador_interatividade">
        ...
        <x-radio id="indicador1a" name="questionario_item1" :value="$questoes->Q1A->question">
            <x-svg-tooltip :message="$messages->q1ma->message" color='green'/>
        </x-radio>

        <x-radio id="indicador1b" name="questionario_item1" :value="$questoes->Q1B->question">
            <x-svg-tooltip :message="$messages->q1mb->message" color='green'/>
        </x-radio>

        <x-radio id="indicador1c" name="questionario_item1" :value="$questoes->Q1C->question">
