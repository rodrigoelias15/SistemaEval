...
<x-cards.template>
    ...
    <div class="mb-4">
        ...
        <p><span class="cabecalho"> Título do Item: </span> {{$dadosQuestionario->nome_item_digital_questionario}} </p>
        <p><span class="cabecalho"> Nome do Avaliador: </span> {{$dadosQuestionario->nome_avaliador_questionario}} </p>
        <p><span class="cabecalho"> Data da Avaliação: </span> {{ (new DateTime($dadosQuestionario->data_item_digital_questionario))->format('d/m/Y')}} </p>
        <p><span class="cabecalho"> Nível de Interatividade: </span> {{$dadosQuestionario->interatividade}} </p>
        <p><span class="cabecalho"> Classificação da Interatividade: </span> {{$dadosQuestionario->classificacaoInteratividade}} </p>
